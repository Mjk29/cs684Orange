...
test('TOGGLE_LOGIN_MODAL', () => 
...
},
 {
	...
	loginState:{loginWindowState:true}});
	expect(state).toEqual({
  	loading:false,
	singleItem:[],
	multipleItems:[],
