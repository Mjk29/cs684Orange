...
describe('reducer tester', () => {
	...
	test('set cart modal state', () => {
	  let state;
	  state = reducers({loading:false,singleItem:[],multipleItems:[],cartItems:{},userEmail:'0l8d5x22a0ymf8l80oskdk',loginWindowState:false,cartModalState:false,userHasAuthenticated:false,previouslyLoggedIn:false}, {type:'TOGGLE_CART_MODAL',cartModalState:{cartModalState:true}});
	  expect(state).toEqual({loading:false,singleItem:[],multipleItems:[],cartItems:{},userEmail:'0l8d5x22a0ymf8l80oskdk',loginWindowState:false,cartModalState:true,userHasAuthenticated:false,previouslyLoggedIn:false});
	});


	test('set login modal state', () => {
	  let state;
	  state = reducers({loading:false,singleItem:[],multipleItems:[],cartItems:{},userEmail:'0l8d5x22a0ymf8l80oskdk',loginWindowState:false,cartModalState:false,userHasAuthenticated:false,previouslyLoggedIn:false}, {type:'CHANGE_USER_LOGIN_WINDOW_STATE',loginState:{loginWindowState:true}});
	  expect(state).toEqual({loading:false,singleItem:[],multipleItems:[],cartItems:{},userEmail:'0l8d5x22a0ymf8l80oskdk',loginWindowState:true,cartModalState:false,userHasAuthenticated:false,previouslyLoggedIn:false});
	});
